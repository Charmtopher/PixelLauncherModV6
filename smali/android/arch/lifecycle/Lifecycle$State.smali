...
# static fields
.field public static final enum R:Landroid/arch/lifecycle/Lifecycle$State;

.field public static final enum S:Landroid/arch/lifecycle/Lifecycle$State;

.field public static final enum T:Landroid/arch/lifecycle/Lifecycle$State;

.field public static final enum U:Landroid/arch/lifecycle/Lifecycle$State;

.field public static final enum V:Landroid/arch/lifecycle/Lifecycle$State;

.field private static final synthetic W:[Landroid/arch/lifecycle/Lifecycle$State;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/Lifecycle$State;->R:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    sput-object v0, Landroid/arch/lifecycle/Lifecycle$State;->S:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    sput-object v0, Landroid/arch/lifecycle/Lifecycle$State;->T:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    sput-object v0, Landroid/arch/lifecycle/Lifecycle$State;->U:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    sput-object v0, Landroid/arch/lifecycle/Lifecycle$State;->V:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    sget-object v1, Landroid/arch/lifecycle/Lifecycle$State;->S:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    sget-object v1, Landroid/arch/lifecycle/Lifecycle$State;->V:Landroid/arch/lifecycle/Lifecycle$State;

    aput-object v1, v0, v6

    sput-object v0, Landroid/arch/lifecycle/Lifecycle$State;->W:[Landroid/arch/lifecycle/Lifecycle$State;
...
.method public static values()[Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 150
    sget-object v0, Landroid/arch/lifecycle/Lifecycle$State;->W:[Landroid/arch/lifecycle/Lifecycle$State;
